<script lang="ts">
	...
	const jsonLd = $derived(
		JSON.stringify({
			...
			headline: `${author}'s fanmail to Kevin Feige`,
...
<svelte:head>
	<title>{author}'s fanmail to Kevin Feige · marvelfansforfeige.com</title>
	<meta name="description" content={ogDesc} />
	<link rel="canonical" href={canonical} />
	<meta property="og:type" content="article" />
	<meta property="og:url" content={canonical} />
	<meta property="og:title" content={`${author}'s fanmail to Kevin Feige`} />
	<meta property="og:description" content={ogDesc} />
	<meta property="og:image" content={ogImage} />
	<meta property="og:site_name" content="marvelfansforfeige.com" />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:title" content={`${author}'s fanmail to Kevin Feige`} />
...
<XPWindow title="Fanmail Permalink — marvelfansforfeige.com" icon="🔗">
	...
	<div class="font-tahoma mt-3 flex items-center justify-between gap-2 text-xs text-[#404040]">
		<a href="/comments" class="text-xp-blue underline">← Back to all fanmail</a>
